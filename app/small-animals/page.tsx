...
import { smallAnimalProducts } from "@/lib/data";
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-32 pb-20">
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 mb-8">
        <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <span className="text-gray-900 dark:text-white font-medium">Small Animal Food</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 mb-12">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
            Specialized nutrition for rabbits, birds, guinea pigs, hamsters, and other
            small pets. Our formulas are designed to meet the unique dietary needs of
            each species.
          </p>
        </motion.div>
      </div>
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {smallAnimalProducts.map((product, index) => (
            <ProductCard
              key={product.name}
              name={product.name}
